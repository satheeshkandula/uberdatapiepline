...
def run_uber_etl():
    ...
    df = pd.read_csv('https://storage.googleapis.com/uber-dataengineering-project-sk7/uber_data.csv')
    ...
    data = {"datetime_dim":datetime_dim,
    ...
    for key, value in data.items():
        value.to_csv("s3://satheesh-airflow-uber-bucket/{}.csv".format(key))
